 ...
 * */
public class _3_SingletonHungry {
    private static _3_SingletonHungry instance = new _3_SingletonHungry();
    private _3_SingletonHungry(){}
    public static _3_SingletonHungry getInstance() {
        return instance;
    }
}